...
from documentation_ai_agent.crew import App
...
def run():
    ...
    inputs = {
        ...
        # 'code_refactored_path': os.path.join(root_path, 'public', 'SuggestionImprovement.md'),
        # 'documentation_path': os.path.join(root_path, 'public', 'DocumentationSystem.md'),
        ...
        # 'template_L3': os.path.join(root_path, 'public', 'templates', 'documentation_L3.md'),
    }
